...
See `.claude/docs/technical-preferences.md` → Engine Specialists → File Extension Routing.

When in doubt, use the primary engine specialist (e.g. `@godot-specialist`).
