---
description: Read a story file and implement it. Loads the full context (story, GDD requirement, ADR guidelines, control manifest), routes to the right programmer agent for the system and engine, implements the...
agent: build
---
...
This command bridges planning and code. It reads a story file in full, assembles
