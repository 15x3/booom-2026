---
description: Validate readiness to advance between development phases. Produces a PASS/CONCERNS/FAIL verdict with specific blockers and required artifacts. Use when user says
agent: producer
---
...
This command validates whether the project is ready to advance to the next development
...
This command is prescriptive ("are we ready to advance?" with a formal verdict).
...
This command follows the collaborative design principle:
