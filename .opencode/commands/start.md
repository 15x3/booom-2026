...
This command writes one file: `production/review-mode.txt` (review mode config set in Phase 3b).

This command is the entry point for new users. It does NOT assume you have a game idea, an engine preference, or any prior experience. It asks first, then routes you to the right workflow.
