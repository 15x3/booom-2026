---
description: Validates a UX spec, HUD design, or interaction pattern library for completeness, accessibility compliance, GDD alignment, and implementation readiness. Produces APPROVED / NEEDS REVISION / MAJOR R...
agent: build
---

Arguments: [file-path or 
...
This command is READ-ONLY — it never edits or writes files. It reports findings only.
