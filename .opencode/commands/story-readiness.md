---
description: Validate that a story file is implementation-ready. Checks for embedded GDD requirements, ADR references, engine notes, clear acceptance criteria, and no open design questions. Produces READY / NEE...
agent: build
model: anthropic/claude-haiku-4-5-20251001
---

Arguments: [story-file-path or 

# Story Readiness

This command validates that a story file contains everything a developer needs
...
**This command is read-only.** It never edits story files. It reports findings
...
This command is read-only. It never proposes edits or asks to write files.
