---
description: Guided, section-by-section authoring of the master architecture document for the game. Reads all GDDs, the systems index, existing ADRs, and the engine reference library to produce a complete archi...
...
This command produces `docs/architecture/architecture.md` — the master architecture
...
This command creates the whole-system blueprint that gives ADRs their context.
...
This command follows the collaborative design principle at every phase:
