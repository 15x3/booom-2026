---
description: Translate approved GDDs + architecture into epics — one epic per architectural module. Defines scope, governing ADRs, engine risk, and untraced requirements. Does NOT break into stories — run /crea...
agent: build
---

Arguments: [system-name | layer: foundation|core|feature|presentation | all] [--review full|lean|solo]
