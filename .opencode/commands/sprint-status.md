---
description: Fast sprint status check. Reads the current sprint plan, scans story files for status, and produces a concise progress snapshot with burndown assessment and emerging risks. Run at any time during a...
agent: build
model: anthropic/claude-haiku-4-5-20251001
---

Arguments: [sprint-number or blank for current]
...
**This command is read-only.** It never proposes changes, never asks to write
...
This command is read-only. It reports observed facts from files on disk.
