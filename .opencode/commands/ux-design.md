---
description: Guided, section-by-section UX spec authoring for a screen, flow, or HUD. Reads game concept, player journey, and relevant GDDs to provide context-aware design guidance. Produces ux-spec.md (per scr...
agent: build
---

Arguments: [screen/flow name] or 
...
This command uses `ux-designer` as the primary agent (set in frontmatter). For
...
This command follows the collaborative design principle at every step:
