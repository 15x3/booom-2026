---
description: Holistic cross-GDD consistency and game design review. Reads all system GDDs simultaneously and checks for contradictions between them, stale references, ownership conflicts, formula incompatibilit...
agent: creative-director
model: anthropic/claude-opus-4-20250514
---

Arguments: [focus: full | consistency | design-theory | since-last-review]

# Review All GDDs

This command reads every system GDD simultaneously and performs two complementary
...
completeness. This command reviews the *relationships* between all GDDs.
