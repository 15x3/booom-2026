---
description: Break a single epic into implementable story files. Reads the epic, its GDD, governing ADRs, and control manifest. Each story embeds its GDD requirement TR-ID, ADR guidance, acceptance criteria, st...
agent: build
---

Arguments: [epic-slug | epic-path] [--review full|lean|solo]
