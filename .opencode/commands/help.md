---
description: Analyzes what is done and the users query and offers advice on what to do next. Use if user says what should I do next or what do I do now or I
agent: build
model: anthropic/claude-haiku-4-5-20251001
---

Arguments: [optional: what you just finished, e.g. 

# Studio Help — What Do I Do Next?

This command is read-only — it reports findings but writes no files.

This command figures out exactly where you are in the game development pipeline and
